<script>
  ...
  import { clickBagsButton, clickJewelryButton, clickShoesButton } from "$lib/services/clickStates";
  ...
  <div id="carouselCover" class="carousel slide" data-bs-ride="true">
    ...
    <div class="carousel-inner">
      <div
        ...
        <img src="src/lib/img/cover/bolsos.jpg" class="d-block w-100" alt="Bags" />
      ...
      <div
        ...
        <img src="src/lib/img/cover/ring.jpg" class="d-block w-100" alt="Ring" />
        <button class="svg-wrapper text-align-center" on:click={clickTheJewelryButton}>
          <a href="/jewelry">
            <svg height="90" width="600">
              <rect class="shape" height="73" width="280" />
            </svg>
      ...
      <div
        ...
        <img src="src/lib/img/cover/shoes2.jpg" class="d-block w-100" alt="Shoes" />
